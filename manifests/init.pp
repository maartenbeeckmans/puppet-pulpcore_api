...
class pulpcore_api (
  ...
  Optional[Hash]              $container_container_mirror_defaults,
  Optional[Hash]              $deb_apt_mirrors,
  Optional[Hash]              $deb_apt_mirror_defaults,
  Optional[Hash]              $file_file_mirrors,
  Optional[Hash]              $file_file_mirror_defaults,
  Optional[Hash]              $rpm_rpm_mirrors,
  Optional[Hash]              $rpm_rpm_mirror_defaults,
  Optional[Hash]              $rpm_rpm_trees,
  Optional[Hash]              $rpm_rpm_tree_defaults,

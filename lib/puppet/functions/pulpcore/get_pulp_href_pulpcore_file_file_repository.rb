...
Puppet::Functions.create_function(:'pulpcore::get_pulp_href_pulpcore_file_file_repository') do
  dispatch :get_pulp_href_pulpcore_file_file_repository do
    param 'String', :name
    return_type 'Optional[String]'
  end

  def get_pulp_href_pulpcore_file_file_repository(name)
    ...
    Puppet.warning("The function :pulpcore::get_pulp_href_pulpcore_file_file_repository is depricated and will be removed in a future release.")

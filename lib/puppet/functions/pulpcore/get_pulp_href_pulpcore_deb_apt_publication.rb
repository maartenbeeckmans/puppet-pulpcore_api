...
Puppet::Functions.create_function(:'pulpcore::get_pulp_href_pulpcore_deb_apt_publication') do
  dispatch :get_pulp_href_pulpcore_deb_apt_publication do
    param 'String', :name
    return_type 'Optional[String]'
  end

  def get_pulp_href_pulpcore_deb_apt_publication(name)
    ...
    Puppet.warning('The function :pulpcore::get_pulp_href_pulpcore_deb_apt_publication is deprecated and will be removed in a future release.')

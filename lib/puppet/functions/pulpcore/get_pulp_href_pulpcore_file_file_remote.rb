...
Puppet::Functions.create_function(:'pulpcore::get_pulp_href_pulpcore_file_file_remote') do
  dispatch :get_pulp_href_pulpcore_file_file_remote do
    param 'String', :name
    return_type 'Optional[String]'
  end

  def get_pulp_href_pulpcore_file_file_remote(name)
    ...
    Puppet.warning('The function :pulpcore::get_pulp_href_pulpcore_file_file_remote is deprecated and will be removed in a future release.')

...
Puppet::Functions.create_function(:'pulpcore::get_pulp_href_pulpcore_container_container_remote') do
  dispatch :get_pulp_href_pulpcore_container_container_remote do
    param 'String', :name
  ...
  def get_pulp_href_pulpcore_container_container_remote(name)
    ...
    Puppet.warning('The function :pulpcore::get_pulp_href_pulpcore_container_container_remote is deprecated and will be removed in a future release.')

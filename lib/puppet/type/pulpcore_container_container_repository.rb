...
Puppet::ResourceApi.register_type(
  name: 'pulpcore_container_container_repository',
  docs: <<-EOS,
@summary Resource for creating pulpcore_container_container_repository

This type provides Puppet with the capabilities to manage a pulp pulpcore_container_container_repository
EOS
  features: [],
  attributes: {
    ensure: {

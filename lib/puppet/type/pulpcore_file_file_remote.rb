...
Puppet::ResourceApi.register_type(
  name: 'pulpcore_file_file_remote',
  docs: <<-EOS,
@summary Resource for creating pulpcore_file_file_remote

This type provides Puppet with the capabilities to manage a pulp pulpcore_file_file_remote
EOS
  features: [],
  attributes: {
    ensure: {

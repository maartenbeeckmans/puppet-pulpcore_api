...
Puppet::ResourceApi.register_type(
  name: 'pulpcore_rpm_rpm_distribution',
  docs: <<-EOS,
@summary Resource for creating pulpcore_rpm_rpm_distribution

This type provides Puppet with the capabilities to manage a pulp pulpcore_rpm_rpm_distribution
EOS
  features: [],
  attributes: {
    ensure: {
